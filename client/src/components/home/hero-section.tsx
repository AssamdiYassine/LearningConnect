...
export default function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#1D2B6C] via-[#5F8BFF] to-[#7A6CFF] text-white">
      {/* Background elements */}
      ...
      <div className="relative w-full max-w-[1200px] mx-auto px-6 md:px-12 lg:px-20 py-20 sm:py-28 md:py-32">
